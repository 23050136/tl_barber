...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($user && password_verify($password, $user['password'])) {
            ...
            // Set cookie (if JWT is available, token will be JWT; otherwise it's 'session_token')
            if ($token !== 'session_token') {
                // JWT is available, set cookie
            ...
            // Session is already set by generateJWT if JWT is not available
